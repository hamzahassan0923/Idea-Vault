...
const Navbar = () => {
    return (
        <div className="navbar sticky top-0 z-50 bg-white/20 backdrop-blur border-b border-base-300 mx-auto container">
  <div className="navbar-start">
    ...
    <Link href={"/"} className="font-bold text-xl">IdeaVault</Link>
  </div>
